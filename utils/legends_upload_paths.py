def race_ilustration_upload(instance, filename):
    ...
    path = f'main/legends/races/{race_name}/{filename}'
...
def specialization_ilustration_upload(instance, filename):
    ...
    path = f'main/legends/specializations/{specialization_name}/{filename}'
...
def item_ilustration_upload(instance, filename):
    ...
    path = f'main/legends/items/{item_name}/{filename}'
...
def character_ilustration_upload(instance, filename):
    ...
    path = f'main/legends/characters/{character_name}/{filename}'
...
def weapon_ilustration_upload(instance, filename):
    ...
    path = f'main/legends/weapons/{weapon_name}/{filename}'
